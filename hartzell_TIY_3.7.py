...
# Announcing that only two can go now
print(" Sorry everyone, I can only invite two people now")

# Using pop to remove all but two
popped_guests = guests.pop()
print(guests)
print(popped_guests)
print(f"Sorry{popped_guests}, you are uninvited")
...
# Messaage to two people who are left
print("Dear Triple H, you are still invited")
print("Dear JohnCean, you are still invited")
